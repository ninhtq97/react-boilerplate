...
export const Search: React.FC<IconProps> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clip-path="url(#clip0_901_44154)">
        <path
...
export const ArrowLeft: React.FC<IconProps> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clip-path="url(#clip0_908_30405)">
        <path
          d="M5 12H19"
          stroke="currentColor"
          stroke-width="1.75"
...
export const ArrowRight: React.FC<IconProps> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clip-path="url(#clip0_908_8440)">
        <path
          d="M5 12H19"
          stroke="currentColor"
          stroke-width="1.75"
...
export const Plus: React.FC<IconProps> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clip-path="url(#clip0_918_1476)">
        <path
...
export const Eye: React.FC<IconProps> = (props) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clip-path="url(#clip0_908_7007)">
        <path
